...
fCOuNT_RUN_1ST_LEVEL_TESTS_new = function(data, fc, test_type, form, var_idx) {
  ...
  first_level_results = lapply(seq_len(K), fCOuNT_run_tests) %>%
    bind_rows()
